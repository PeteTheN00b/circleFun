...
void myShapes::Circle::draw(Window* win, int accuracy) const //I'd like to leave this comment as a reminder to my stupid self that passing an argument through means you should use a god damn pointer
{
